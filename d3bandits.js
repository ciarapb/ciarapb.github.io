...
// set seed and sort out checked box
function setseed(){
...
// get reward from an arm with success probability p
...
// function to update the counts for all arms    
...
// place the updated counts in the score table in the html file
...
// get highest ucb to show up red 
...
// function to add ucbs to table if that option is selected
function addUCBS(tableID) {

    var table = document.getElementById(tableID);

    // if there are only 6 rows add ucbs as another row
    ...
    // if there are 7 rows => ucbs are there so remove them
    if(rowCount==7){
...
// create click box for showing ucbs
function showMe (box) {
...
// make instantaneous reward dissappear after a while
...
// When the user clicks on the (x) button, close the instructions
spanclose.onclick = function() {
    mymodal.style.display = "none";
}

// When the user clicks anywhere outside of the instructions, close it
